        ...
        <div style={{ animation: 'tabFadeIn 0.25s ease' }}>
          ...
          <div className="pension-info-grid">
            {[
              ...
              { label: '예상 납부 보험료', value: totalPaidNum, color: '#F5A623', icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{
            ...
            <div style={{ padding: '1.75rem', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.35rem', color: '#f59e0b', fontWeight: 800, marginBottom: '0.3rem' }}>
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>
                  </svg>
                  안내 사항
                </div>
                <div>ㆍ향후 소득과 물가가 변동없는 것으로 가정하여 산정</div>
                <div>ㆍ가입된 소득으로 60세까지 납부를 가정</div>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  <label style={{ display: 'flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.8rem', fontWeight: 700, color: 'var(--text-secondary)', marginBottom: '0.5rem' }}>
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#6366f1' }}>
                      <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
                    </svg>
                    예상 납부월수
                  </label>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <input
                      style={{
                        flex: 1, width: '100%', background: 'var(--card)', border: '1.5px solid rgba(99, 102, 241, 0.2)',
                        color: 'var(--text-primary)', borderRadius: 'var(--radius-sm)',
                        padding: '0.825rem 1rem', fontSize: '0.95rem', fontFamily: 'inherit',
                        fontWeight: 600, outline: 'none', transition: 'all 0.2s ease',
                        boxSizing: 'border-box', textAlign: 'center',
                      ...
                      onChange={e => handleNationalChange('expectedMonths', e.target.value)}
                    />
                    <span style={{ fontSize: '0.85rem', fontWeight: 800, color: 'var(--text-secondary)', whiteSpace: 'nowrap' }}>개월</span>
                  </div>
                </div>
              </div>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <span style={{ width: 4, height: 12, borderRadius: 2, background: '#5B6BF8', display: 'inline-block' }} />
                  예상 노령연금액
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  {[
                    { key: 'beforeTax', label: '세전', color: '#5B6BF8', placeholder: '예: 1000000' },
                    { key: 'afterTax',  label: '세후', color: '#2DC9A0', placeholder: '예: 850000'  },
                  ].map(f => (
                    <div key={f.key}>
