...
export default function TopBar({ onHamburger, onSaveSync, onDataModal, onManual, onGithubModal }) {
  const { year, setYear, month, setMonth, dark, toggleTheme, navSection } = useApp();
    ...
    <div className="topbar">
      ...
      <div className="topbar-center">
        ...
        <div className="topbar-actions">
          ...
          {/* GitHub */}
          <button className="topbar-btn nav-action-btn" onClick={onGithubModal} title="GitHub 동기화" aria-label="GitHub">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
