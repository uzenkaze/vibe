...
if (Test-Path "carrep/dist/assets") {
    ...
    Copy-Item -Path "carrep/dist/assets/*" -Destination "carrep/assets/" -Recurse -Force
}
...
Get-ChildItem -Path $deployDir -Recurse -Force -ErrorAction SilentlyContinue | Where-Object { $_.Name -eq ".git" } | Remove-Item -Recurse -Force
