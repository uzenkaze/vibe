...
const viewQueryHTML = `
                <div id="view-query" class="view-section" style="background-color: #fafafa; padding: 2.5rem; min-height: 100vh;">
                    <style>
                    ...
                    <div class="query-header-container">
                        <div>
                            ...
                            <p>유용한 쿼리 및 코드 스니펫 모음</p>
                        </div>
                        <div style="display:flex; gap:12px; align-items: center;">
                            <div class="search-container" style="width: 280px;">
                                <input type="text" id="query-search-input" class="news-search-input" placeholder="메모 검색..." oninput="renderQueries()" style="border-radius: 20px; padding: 0.6rem 1.2rem; border: 1px solid rgba(0,0,0,0.1); width: 100%; box-sizing: border-box; font-size: 0.95rem;">
                            </div>
                    ...
                    <div id="query-grid" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.8rem; padding: 1rem 0 4rem 0;">
                        <!-- 쿼리 카드 렌더링 -->
                    </div>
                </div>
`;
if (!content.includes('<div id="view-query" class="view-section"')) {
